...
IUSE="abi_mips_n32 audit debug hpn kerberos kernel_linux ldns libedit libressl livecd pam +pie +scp sctp security-key selinux +ssl static test X X509 xmss"
...
LIB_DEPEND="
	...
	ssl? (
		!libressl? ( >=dev-libs/openssl-1.1.1i-r1:0[static-libs(+)] )
